...
{"pathname":"/index.page","title":"","filePath":"src/pages/index.page.tsx","publishedAt":"2022-02-05T04:13:29.720Z","updatedAt":"2022-02-05T04:13:29.720Z","commitCount":0},
...
export const pageListByUpdatedAt: Array<PageData> = (JSON.parse("[0,1,2,3,4,5,7,6]") as Array<number>).map((index) => pageListByPublishedAt[index]);
