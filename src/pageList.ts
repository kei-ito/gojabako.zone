...
{"pathname":"/","title":"トップページ","filePath":"src/pages/index.page.tsx","publishedAt":"2021-09-29T00:33:31+09:00","updatedAt":"2022-02-05T13:14:23+09:00","commitCount":16}
]`);
export const pageListByUpdatedAt: Array<PageData> = (JSON.parse("[7,0,1,2,3,4,6,5]") as Array<number>).map((index) => pageListByPublishedAt[index]);
